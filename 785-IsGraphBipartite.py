...
# graph[i] will not contain i or duplicate values. The
# graph is undirected: if any element j is in graph[i], then i will be in graph[j].
...
class Solution(object):
    def isBipartite(self, graph):
        ...
        :rtype: bool
        """
        # refer from https://blog.csdn.net/u010829672/article/details/79593924
        def dfs(v, cur_color):
            if v in color:
